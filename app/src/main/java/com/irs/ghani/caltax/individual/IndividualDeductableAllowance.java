...
public class IndividualDeductableAllowance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mNext = findViewById(R.id.btn_individualDeductibleAllowance_next);
        mNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(IndividualDeductableAllowance.this , TaxCreditsActivity.class);
